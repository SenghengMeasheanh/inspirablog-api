/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: c36a2b3d466cd71d2338f8e41fb095a7)
...
declare namespace Cloudflare {
	...
	interface Env {
		APP_NAME: "InspiraBlog";
		RESEND_CONTACT_TO_EMAIL: "support@inspirablog.com";
		RESEND_FROM: "no-reply@inspirablog.com";
		RESEND_API_KEY: "re_96vD8WWk_GhBRJKy6W2oYkKULzxTZG79s";
		DATABASE_URL: string;
		RESENT_API_KEY: string;
		RESENT_FROM_EMAIL: string;
